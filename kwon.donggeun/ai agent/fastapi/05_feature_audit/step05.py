"""
Step 05: 피처 감사 (Feature Redundancy Pre-Audit)
...
router = APIRouter(prefix="/05", tags=["05. Feature Audit"])
...
def feature_audit():
    """Step 05: VIF · 고상관 쌍 · zero-inflation 감사. 항상 재실행."""
    ...
    save_json("step05_result", result)
    mark_done("step05", {
