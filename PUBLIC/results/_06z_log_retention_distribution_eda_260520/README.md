# 06z log retention distribution EDA
...
- `PUBLIC/data/06z_expanded_dataset_log_retention.csv`
- `PUBLIC/data/06z_expanded_dataset_promo_0_log_retention.csv`
- `PUBLIC/data/06z_expanded_dataset_promo_1_log_retention.csv`

## Outputs

- `06z_log_retention_distribution_summary.csv`
- `06z_log_retention_baseline_direction_summary.csv`
- `06z_fig_01_log_retention_histograms.png`
- `06z_fig_02_log_retention_boxplot_by_dataset.png`
- `06z_fig_03_overall_raw_vs_log_histograms.png`
